...
(function(k) {
  ...
  }var o = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, p = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, f, m, r = {"\u0008":"\\b", "\t":"\\t", "\n":"\\n", "\u000c":"\\f", "\r":"\\r", '"':'\\"', "\\":"\\\\"}, i;
  function q(a) {
    p.lastIndex = 0;
  ...
  if(typeof k.a.stringify !== "function")k.a.stringify = function(a, c, d) {
    var g;
    m = f = "";
    if(typeof d === "number")for(g = 0;g < d;g += 1)m += " ";
    else if(typeof d === "string")m = d;
    if((i = c) && typeof c !== "function" && (typeof c !== "object" || typeof c.length !== "number"))throw new Error("JSON.stringify");return n("", {"":a})
  };
  if(typeof k.a.parse !== "function")k.a.parse = function(a, c) {
    function d(g, j) {
      var e, b, h = g[j];
    ...
    o.lastIndex = 0;
    if(o.test(a))a = a.replace(o, function(g) {
